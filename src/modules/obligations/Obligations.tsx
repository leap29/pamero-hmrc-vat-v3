...
export default class HMRCRedirect extends Component<HMRCRedirectProps, HMRCRedirectState> {
    ...
    async componentDidMount() {
        ...
        try {
            ...
            this.setState({ isLoading: false, accessToken: tokens.accessToken, refreshToken: tokens.refreshToken, grantedScope: tokens.grantedScope, expiresIn: tokens.expiresIn, obligations: tokens.obligations });
        } catch (e) {
